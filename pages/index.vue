  ...
  <div>
    <div class="mb-8 space-x-2 items-center text-center overflow-hidden">
      <h4
        ...
        "
        class="tracking-wide py-2 bg-purple-400 uppercase text-2xl pl-10 pr-4 text-white font-bold hover:text-gray-500"
      >
        Awesomly Tested
      </h4>
    ...
    <main class="mt-16 mx-auto max-w-7xl px-4 mb-16 sm:mt-24">
      <div class="text-center">
        <h1
          class="text-4xl leading-8 tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl"
        >
          <span class="block text-purple-600 xl:inline">Discover Tests</span
          ><br />
          <span class="block xl:inline"
            >from the most popular <br />GitHub repos</span
          >
        </h1>
        <p
          class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
        >
          Not sure how proper tests should look like? Learn from the best
          open-source projects in the community. We scan and analyze
          <b>JavaScript & TypeScript</b> repositories and list all their tests
          on one page!
        </p>
      </div>
    </main>

    <div class="py-4 flex justify-center uppercase space-x-8">
      <a
        href="/facebook/react"
      ...
      <div class="text-sm text-gray-400">
        and <b>{{ list.length - 4 }}</b> more...
      </div>
    </div>

    <div class="mt-16 flex mx-auto max-w-7xl px-4 mb-16 sm:mt-24">
      <h4
        class="flex-1 w-1/3 font-extrabold text-gray-600 space-x-4 text-2xl my-8"
      >
        Are your tests awesome?<br />
        Make your tests visible! Add this <b>badge</b> to your repo
      </h4>
    ...
    <div
      class="flex px-8 border-t-4 border-gray-100 mt-4 justify-between items-center"
    >
      <h4
        class="flex-1 w-1/3 font-extrabold text-gray-600 space-x-4 text-2xl my-8"
      >
